...
int main()
{
    ...
    */
    ...
    cout << "bfs_t: " << double(bfs_t)/CLOCKS_PER_SEC << endl;
    cout << "ek_t: " << double(ek_t)/CLOCKS_PER_SEC << endl;
    cout << "res_net_t: " << double(res_net_t)/CLOCKS_PER_SEC << endl;
    cout << "res_cap_t: " << double(res_cap_t)/CLOCKS_PER_SEC << endl;
    cout << "augment_t: " << double(augment_t)/CLOCKS_PER_SEC << endl;
    cout << "reduction_t: " << double(reduction_t)/CLOCKS_PER_SEC << endl;
    cout << "sol_t: " << double(sol_t)/CLOCKS_PER_SEC << endl;
